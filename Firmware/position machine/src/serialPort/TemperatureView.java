...
public class TemperatureView extends JFrame {
	...
	public void getdat(String str) {
		...
		addValue((int) (Origin_Y-MAX_Y/45.0*datnum));
	}
...
//	}
	...
	class MyCanvas extends JPanel {
		...
		public void paintComponent(Graphics g) {
			...
			// 画Y轴刻度
			for (int i = Origin_Y, j = 0; i > YAxis_Y; i -= DISTANCE_INTERVAL, j += 5) {
				g.drawString(j + " ", Origin_X - 30, i + 3);
			}
			g.drawString("温度/°C", YAxis_X - 5, YAxis_Y - 5);// 血压刻度小箭头值
			// 画网格线
			g.setColor(Color.BLACK);
			// 坐标内部横线
